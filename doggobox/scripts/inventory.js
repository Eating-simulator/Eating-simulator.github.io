var inventory = {
    ...
    updateOnPage: function() {
        ...
        switch (sword.name) {
            case "play-doh sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiPlaydohSwordWithoutButton);
                break;
            case "plastic sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiPlasticSwordWithoutButton);
                break;
            case "turtleshell sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiTurtleshellSwordWithoutButton);
                break;
            case "solidified rubber sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiSilverSwordWithoutButton);
                break;
            case "depleted uranium sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiDiamondSwordWithoutButton);
                break;
            case "doggo depleted uranium sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiCandyDiamondSword);
                break;
            case "polished doggo depleted uranium sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiPolishedCandyDiamondSword);
                break;
            case "chocolate sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiChocolateSword);
                break;
            case "sharp chocolate sword":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiSharpChocolateSword);
                break;
            case "Sword of Flames":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiSwordOfFlames + "\n\nLevel : " + sword.specialPower);
                break;
            case "Sword of Life":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiSwordOfLife + "\n\nLevel : " + sword.specialPower);
                break;
            case "Sword of Summoning":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiSwordOfSummoning + "\n\nLevel : " + sword.specialPower);
                break;
            case "Sword of Liflamesummoning":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiSwordOfLiflamesummoning + "\n\nLevel : " + sword.specialPower);
                break;
            case "Sword of Randomness":
                htmlInteraction.setInnerHtml("sword_without_button", sword.asciiSwordOfRandomness + "\n\nLevel : infinite + " + sword.specialPower);
                break;
        }
        ...
        this.updateObjectOnPage("inventory_doggi_converter", objects.list.doggiConverter, this.asciiCandiesConverter, this.asciiNoObject);
