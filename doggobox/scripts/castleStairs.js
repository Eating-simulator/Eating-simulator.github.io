var castleStairs = {
    ...
    makeNecromancer: function() {
        return land.createMob("NEC", 150, 150, "magic staff", "A necromancer. She summons ghosts and dead stuff.", [drops.createDrop("object", "doggiConverter", true), drops.createDrop("object", "cauldron", true)]);
    },
