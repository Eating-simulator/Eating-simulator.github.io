var cowLevel = {
    ...
    makeCow: function() {
        return land.createMob("COW", 12, 12, "horns", "A cow ! Mooooo !", [drops.createDrop("doggi", 100)]);
    },

    makeCowKing: function() {
        return land.createMob("COW", 180, 180, "horns", "The cow king ! It looks like a normal cow, but it isn't...", [drops.createDrop("doggi", 1000), drops.createDrop("object", "hornOfPlenty", true)]);
    }
