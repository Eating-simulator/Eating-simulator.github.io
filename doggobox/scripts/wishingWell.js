...
"
        ...
        switch (this.step) {
            case 0:
                // Button
                text += "\n\n<button id=\"wishingWell_throw_doggo\" onClick=\"wishingWell.throwCandy();\">Throw a doggo in the well</button>";
                break;
            case 1:
                // Speech
                text += "\n";
                ...
                // Buttons
                text += "\n\n<button onClick=\"wishingWell.doggiBy5();\">Multiply my doggi by 5</button>";
                text += "\n<button onClick=\"wishingWell.dogesBy8();\">Multiply my doges by 8</button>";
    ...
    doggiBy5: function() {
        doggi.setNbrOwned(doggi.nbrOwned * 5);
        this.setStep(2);
        this.setSpeech("Multiplicatus, multiplicata, multiplicatum ! Your doggi are now multiplied !");
        this.updateOnPage();
    },

    dogesBy8: function() {
        doges.setNbrOwned(doges.nbrOwned * 8);
        this.setStep(2);
        this.setSpeech("Multiplicatus, multiplicata, multiplicatum ! Your doges are now multiplied !");
        this.updateOnPage();
    },

    throwCandy: function() {
        doggi.setNbrOwned(doggi.nbrOwned - 1);
        this.setStep(1);
