var castleKeep = {
                        ...
                        for (var i = 2; i < this.realSize - 1; i++) {
                            if (random.oneChanceOutOf(4)) {
                                switch (random.getRandomIntUpTo(6)) {
                                    case 0:
                                        quest.things[i] = castleKeep.makeKomodoDragon();
                                        break;
                                    case 1:
                                        quest.things[i] = castleKeep.makeRhinoceros();
                                        break;
                                    case 2:
                                        quest.things[i] = castleKeep.makeGaur();
                                        break;
                                    case 3:
                                        quest.things[i] = castleKeep.makeDromornisStirtoni();
                                        break;
                                    case 4:
                                        quest.things[i] = castleKeep.makeGorilla();
                                        break;
                                    case 5:
                                        quest.things[i] = castleKeep.makeCapybara();
                                        break;
                                    case 6:
                                        quest.things[i] = castleKeep.makeDoedicurus();
                                        break;
                                }
                            }
                        }
    ...
    makeWalledOffZombieWarrior: function() {
        ...
        return land.createMob("WZW", hp, hp, "cursed sword", "A walled off zombie warrior. He probably did something bad to end up here.", [drops.createDrop("doggi", random.getRandomIntUpTo(1) * 4000), drops.createDrop("object", "oldAmulet", true)]);
    },
