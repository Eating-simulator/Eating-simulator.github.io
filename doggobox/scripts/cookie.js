var cookie = {
    ...
    getData: function() {
        ...
        return "" + ((code === undefined || code == null || code.length == "") ? 0 : code) +
            ...
            ":" + doggi.nbrEaten +
            ":" + doggi.nbrTotal +
            ":" + doggi.doggiPerSecond +
            ":" + getPhpStuff(doggiConverter.activated) +
            ":" + cauldron.bookPage +
            ":" + cauldron.doggiInTheCauldron +
            ":" + cauldron.dogesInTheCauldron +
            ...
            ":" + getPhpStuff(objects.list.doggiConverter.have) +
    ...
    updateData: function(var_list) {
        ...
        doggi.setNbrOwned(Number(var_list[4]));

        if (Number(var_list[5]) != 0) {
            doggi.setNbrThrown(Number(var_list[5]));
        } else {
            doggi.nbrThrown = Number(var_list[5]);
        }

        if (Number(var_list[6]) != 0) {
            doggi.setNbrEaten(Number(var_list[6]));
        } else {
            doggi.nbrEaten = Number(var_list[6]);
        }


        doggi.setNbrTotal(Number(var_list[7]));

        doggi.setCandiesPerSecond(Number(var_list[8]));
        doggiConverter.setActivated(setPhpStuff(Number(var_list[9])));
        ...
        if (Number(var_list[25]) != 0) {
            doges.setNbrOwned(Number(var_list[25]));
        } else {
            doges.nbrOwned = Number(var_list[25]);
        }

        //
        doges.setNbrInStock(Number(var_list[26]));

        doges.setNbrBought(Number(var_list[27]));
        ...
        objects.setHaveObject("doggiConverter", setPhpStuff(Number(var_list[42])));
        ...
        //
        potions.setPotionShown(potions.list.impInvocationScroll, setPhpStuff(Number(var_list[55])));
        potions.setPotionShown(potions.list.earthquakeScroll, setPhpStuff(Number(var_list[54])));
        potions.setPotionShown(potions.list.teleportScroll, setPhpStuff(Number(var_list[53])));
        potions.setPotionShown(potions.list.fireScroll, setPhpStuff(Number(var_list[51])));
        potions.setPotionShown(potions.list.acidRainScroll, setPhpStuff(Number(var_list[52])));
        potions.updateOnPage();
        potions.setPotionShown(potions.list.gmooh, setPhpStuff(Number(var_list[63])));
        potions.setPotionShown(potions.list.superman, setPhpStuff(Number(var_list[62])));
        potions.setPotionShown(potions.list.cloning, setPhpStuff(Number(var_list[61])));
        potions.setPotionShown(potions.list.seed, setPhpStuff(Number(var_list[60])));
        potions.setPotionShown(potions.list.jelly, setPhpStuff(Number(var_list[59])));
        potions.setPotionShown(potions.list.turtle, setPhpStuff(Number(var_list[58])));
        potions.setPotionShown(potions.list.invulnerability, setPhpStuff(Number(var_list[57])));
        potions.setPotionShown(potions.list.majorHealth, setPhpStuff(Number(var_list[56])));
        potions.setPotionShown(potions.list.berserk, setPhpStuff(Number(var_list[50])));
        potions.setPotionShown(potions.list.escape, setPhpStuff(Number(var_list[49])));
        potions.setPotionShown(potions.list.health, setPhpStuff(Number(var_list[48])));
        potions.updateOnPage();
        //
