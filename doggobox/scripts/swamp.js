var swamp = {
    ...
    updateOnPageFinalFrog: function() {
        ...
        switch (this.step) {
            case 4:
                text = speech.makeSpeechFromText("Hello. I'm The Frog. I can provide you doggi, and lots of things. I know how much you love doggi. But I feel alone in this swamp. I'd like to play with you before. If you answer my questions correctly, the sweetest sweets will be yours.", 29, "");
                text += "\n\n<button id=\"answer\" onClick=\"swamp.setStep(5);\">Let's go, then</button>";
                break;
            case 5:
                text = speech.makeSpeechFromText("First question : do you _really_ love doggi?", 29, "");
                text += answer_form;
                break;
            case 6:
                text = speech.makeSpeechFromText("Perfect. Here's 10 doggi. Many more doggi are waiting for you.", 29, "");
            ...
            case 7:
                ...
                break;
            case 8:
                text = speech.makeSpeechFromText("Great. You seem to understand basic logic. Here's 100 doggi.", 29, "");
                text += "\n\n<button id=\"answer\" onClick=\"swamp.setStep(9);\">Next question!</button>";
                break;
            case 9:
                text = speech.makeSpeechFromText("Third question. Consider 10 days. If I give you 1 doggo on the first day, and each other day I give you twice more doggi than the previous one, how much doggi will I give you on the day number 10?", 29, "");
                text += answer_form;
                break;
            case 10:
            ...
            case 11:
                ...
                break;
            case 12:
                text = speech.makeSpeechFromText("Correct! Everyone wants to be a frog. Here's your 1000 doggi.", 29, "");
...
");
    ...
    answer: function() {
        ...
        switch (this.step) {
            case 5:
                if (ans == "yes") {
                    doggi.setNbrOwned(doggi.nbrOwned + 10);
                    this.setStep(6);
            ...
            case 9:
                if (ans == "512") {
                    doggi.setNbrOwned(doggi.nbrOwned + 512);
                    this.setStep(10);
                } else this.setComment("Wrong.");
                break;
            case 11:
                if (ans == "frog" || ans == "afrog" || ans == "thefrog") {
                    doggi.setNbrOwned(doggi.nbrOwned + 1000);
                    this.setStep(12);
                } else this.setComment("Wrong.");
                break;
            case 13:
