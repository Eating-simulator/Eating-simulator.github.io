    ...
    getWeaponDamage: function(weapon) {
        switch (weapon) {
            ...
            case "Sword of Liflamesummoning":
                return 16 + sword.specialPower * 5;
                break;
            case "Sword of Randomness":
                var index = quest.getCharacterIndex();
                switch (random.getRandomIntUpTo(4)) {
                    case 0:
                        quest.things[index].text = "   ";
                        break;
                    case 1:
                        quest.things[index].text = "___";
                        break;
                    case 2:
                        quest.things[index].text = "r" + random.pickRandomly(["a", "p", "^", "'", "-", "+", "n", "m", "s", "o", ","]) + "r";
                        break;
                    case 3:
                        quest.things[index].hp = Math.floor(quest.things[index].hp * random.getRandomFloat() * 2);
                        break;
                    case 4:
                        quest.things[index].hp = Math.floor(quest.things[index].max_hp * random.getRandomFloat() * 2);
                        break;
                }
                return random.getRandomIntUpTo(sword.specialPower * 114);
                break;
                // Traps
            case "powerful explosion":
                return 100;
                break;
                // Clone
            case "cloned sword":
            ...
            case "fins":
                ...
                break;
            case "tentacles":
                return 1 + random.getRandomIntUpTo(5);
                break;
            case "giant tail":
                return 8;
                break;
            case "electric tail":
                return 9 + random.getRandomIntUpTo(2);
                break;
                // Castle's entrance
            case "spear":
                return 7;
            ...
            case "spiky tail":
                ...
                break;
            case "cursed sword":
                return 3 + random.getRandomIntUpTo(20);
                break;
            case "itself":
                return 45;
                break;
            ...
            case "?":
                ...
                // Chuck norris
            case "Chuck Norris":
                return random.getRandomIntUpTo(chuckNorris.timeSpent * 8);
                break;
                // Developper's garden
            case "ultra plasma gun":
                return 8;
                break;
                // Developper's computer
            case "bugs":
                return Math.floor(quest.getCharacterMaxHp() / 4) + 5;
                break;
        }
