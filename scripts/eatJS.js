...
function aprontalk() {
	...
	if (data.chefapron == 9) {
		document.getElementById("yay").innerHTML = "I will take all your data.money if you won't stop.";
		output("You've been threatened!")
	}
